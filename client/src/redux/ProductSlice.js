...
export const GetAllproduct = createAsyncThunk('product/getAll', async() => {
    try {
        let result = await axios.get('http://ecommerce-back-beta.vercel.app/product/all');
        return result;
    } catch (error) {
        console.log(error);
    }
...
export const GetAllcategories = createAsyncThunk('product/getcategories', async() => {
  try {
      let result = await axios.get('http://ecommerce-back-beta.vercel.app/product/');
      return result.data;
  } catch (error) {
      console.log(error);
  }
...
export const getProdutById = createAsyncThunk('/product/productid', async(id) => {
  try {
    let result = await axios.get(`http://ecommerce-back-beta.vercel.app/product/${id}`);
    return result;
  } catch (error) {
    console.log(error);
  }
...
export const PostProduct = createAsyncThunk('product/add', async(product) =>{
  try {
    let result = await axios.post(`http://ecommerce-back-beta.vercel.app/product/`, product);
    return result;
  } catch (error) {
    console.log(error);
  }
...
export const DeleteProduct = createAsyncThunk('product/delete', async(id) => {
  try {
    let result = await axios.delete(`http://ecommerce-back-beta.vercel.app/product/${id}`);
    return result;
  } catch (error) {
    console.log(error);
  }
...
export const UpdateProduct_Put = createAsyncThunk('product/update', async({id, newProduct}) => {
  try {
    let result = await axios.put(`http://ecommerce-back-beta.vercel.app/product/${id}`, newProduct);
    return result.data;
  } catch (error) {
    console.log(error);
  }
...
export const GetHighestPrice = createAsyncThunk('product/getHighestPrice', async () => {
  try {
      let result = await axios.get('http://ecommerce-back-beta.vercel.app/product/highestprice/price');
      return result.data;
  } catch (error) {
      console.log(error);
  }
