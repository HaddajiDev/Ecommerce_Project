...
export const userRegister = createAsyncThunk("user/register", async(user)=>{
	try {
		let result = await axios.post('http://ecommerce-project-pied.vercel.app/user/register', user);
		return await result;
	} catch (error) {
		console.log(error);
	}
...
export const userLogin = createAsyncThunk("user/login", async(user)=>{
	try {
		let result = await axios.post('http://ecommerce-project-pied.vercel.app/user/login', user);		
		return await result;
	} catch (error) {
		console.log(error);
	}
...
export const currentUser = createAsyncThunk("user/current", async()=>{
	try {
		let result = await axios.get('http://ecommerce-project-pied.vercel.app/user/current', {
			headers:{
...
export const UpdateUser = createAsyncThunk('user/update', async ({ id, edited }, { rejectWithValue }) => {
    try {
        let result = await axios.put(`http://ecommerce-project-pied.vercel.app/user/${id}`, edited);
        return result.data;
    } catch (error) {
...
export const AddToCart = createAsyncThunk('user/cart', async({id, stuff}) => {
	try {
		let result = await axios.post(`http://ecommerce-project-pied.vercel.app/user/${id}/cart`, stuff);
		return result;
	} catch (error) {
		console.log(error);
	}
...
export const AddToWishList = createAsyncThunk('user/wishlist', async({id, stuff_1}) => {
	try {
		let result = await axios.post(`http://ecommerce-project-pied.vercel.app/user/${id}/wishlist`, stuff_1);
		return result.data;
	} catch (error) {
		console.log(error);
	}
...
export const getUserOrders = createAsyncThunk('user/order', async(id) => {
    try {
        let result = await axios.get(`http://ecommerce-project-pied.vercel.app/user/${id}/order`);
		return result;
    } catch (error) {
        console.log(error);
    }
...
export const GetAllUsers = createAsyncThunk('user/all', async() => {
	try {
		let result = await axios.get('http://ecommerce-project-pied.vercel.app/user/');
		return result;
	} catch (error) {
		console.log(error);
	}
...
export const DeleteUser = createAsyncThunk('user/delete', async(id) => {
	try {
		let result = await axios.delete(`http://ecommerce-project-pied.vercel.app/user/${id}`);
		return result;
	} catch (error) {
		console.log(error);
	}
...
export const RemoveCartItem = createAsyncThunk('user/cartDel', async({userId, cartId}) =>{
	try {
		await axios.delete(`http://ecommerce-project-pied.vercel.app/user/cart/${userId}/${cartId}`);
	} catch (error) {
		console.log(error);
	}
})
...
export const RemoveWishListItem = createAsyncThunk('user/wishDel', async({userId, cartId}) =>{
	try {
		await axios.delete(`http://ecommerce-project-pied.vercel.app/user/wishlist/${userId}/${cartId}`);
	} catch (error) {
		console.log(error);
	}
})
